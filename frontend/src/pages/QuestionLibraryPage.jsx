...
//     useMathJax([questions, loading]);

//     useEffect(() => {
//         api.get('/questions/filters').then(res => setFilterOptions(res.data));
//     }, []);
...
//         const { name, value } = e.target;
//         const newParams = Object.fromEntries([...searchParams]);
//         if (value) { newParams[name] = value; } else { delete newParams.search; }
//         setSearchParams(newParams);
//     };
...
//         e.preventDefault();
//         const newParams = Object.fromEntries([...searchParams]);
//         if (searchTerm) { newParams.search = searchTerm; } else { delete newParams.search; }
//         setSearchParams(newParams);
//     };
...
//                         <Link to={`/question/${q._id}`} key={q._id} className={styles.questionRow}>
//                             <span className={styles.questionNumber}>Q{index + 1}.</span>
//                             <div className={styles.questionText} dangerouslySetInnerHTML={{ __html: q.questionText }}></div>
//                             <span className={styles.chevronIcon}>&rsaquo;</span>
//                         </Link>
//                     ))
//                 ) : (
//                     <div className={styles.noResults}>No questions found for the selected filters.</div>
